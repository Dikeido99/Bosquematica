...
@onready var level_btn = $divide_levels/level_btn
@onready var level_btn_2 = $divide_levels/level_btn2
@onready var level_btn_3 = $divide_levels/level_btn3
@onready var level_btn_4 = $divide_levels/level_btn4
@onready var level_btn_5 = $divide_levels/level_btn5
...
func _ready():
	if Globals.game_data["mul_level_completed"] > 4:
		...
		if Globals.game_data["div_level_completed"] > 0:
			stats_btn.disabled = false
			level_btn_2.disabled = false
			if Globals.game_data["div_level_completed"] > 1:
				stats_btn_2.disabled = false
				level_btn_3.disabled = false
				if Globals.game_data["div_level_completed"] > 2:
					stats_btn_3.disabled = false
					level_btn_4.disabled = false
					if Globals.game_data["div_level_completed"] > 3:
						stats_btn_4.disabled = false
						level_btn_5.disabled = false
						if Globals.game_data["div_level_completed"] > 4:
